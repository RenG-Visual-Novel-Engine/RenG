...
func New(l *lexer.Lexer) *Parser {
	...
	p.registerPrefix(token.TEXT, p.parseTextExpression)
	...
	p.registerPrefix(token.STYLE, p.parseStyleExpression)
	...
	p.registerPrefix(token.COLOR, p.parseColorExpression)
